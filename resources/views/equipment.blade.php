    ...
    <div class="container fullHeight">
        <div class="row fullHeight jusity-content-center align-items-center">
            <div class="col-12">
                ...
                <h4>View our many models below or download our spec sheet <a href="http://skyjack.com/product/sjiii-3215-19" target="_blank" class="yellow">here</a>.</h4>
                <a href="{{ url('/#homeFormCon') }}" class="landingButton buttonYellow">Get a Quote</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 equipmentInfo">
                ...
                <h4>Download our spec sheet <a href="http://skyjack.com/product/sjiii-3215-19" target="_blank" class="yellow">here</a> for more information.</h4>
            ...
            <div class="col-12 col-lg-6 offset-lg-6 equipmentInfo">
                ...
                <a href="mailto:acarson&commat;clearviewrentals.ca?subject=Rent Now" class="button buttonYellow">Rent Now</a>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row" id="rentImgRow">
            ...
            <div class="col-12 col-md-7 col-lg-8 offset-md-5 offset-lg-4" id="rentInfo">
                ...
                <a href="mailto:acarson&commat;clearviewrentals.ca?subject=Rent Now" class="button buttonYellow">Rent Now</a>
                <a href="{{ url('/#homeFormCon') }}" class="button buttonClear">Get A Quote</a>
            </div>
