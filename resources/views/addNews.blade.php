...
@section('content')
    <div class="row fullHeight align-items-center justify-content-center">
        <div class="col-12">
        <form class="form-horizontal" method="POST" enctype='multipart/form-data' action="{{ url('admin/news/add/') }}">
        <h2>Add News Article</h2>
            ...
            <div class="form-group">
                <label for="subtitle" class="col-12 control-label">Subtitle</label>

                <div class="col-12">
                    <input id="subtitle" type="text" class="form-control" name="subtitle" value="" required>
                </div>
            </div>
